...
//    
//    moveView = [[UIView alloc] initWithFrame:CGRectMake(0, 20, 30, 30)];
//    moveView.backgroundColor = [UIColor redColor];
//    [self.view addSubview:moveView];
}


//- (void)respondsToPan:(UIPanGestureRecognizer*)panRecognizer{
//    CGFloat xPoints = 300.0;
...
- (void)respondsToDoubleTap:(UITapGestureRecognizer*)Taprecognizer{
    NSLog(@"Double Tap");
