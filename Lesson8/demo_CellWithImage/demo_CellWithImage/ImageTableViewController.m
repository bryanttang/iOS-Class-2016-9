...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ImageContentCell *cell = (ImageContentCell*)[tableView dequeueReusableCellWithIdentifier:@"mission_cell" forIndexPath:indexPath];
    
    cell.name.text = [[missions objectAtIndex:indexPath.row] objectForKey:@"name"];
    cell.desp.text = [[missions objectAtIndex:indexPath.row] objectForKey:@"description"];
    cell.level.text = [[missions objectAtIndex:indexPath.row] objectForKey:@"level"];
    [cell setupImage:[[missions objectAtIndex:indexPath.row] objectForKey:@"img"]];
